...
/// contato (ver Agent-Api/src/domain/utils/phone.ts), então o input já força
...
/// deixar o usuário digitar texto livre. Existe pra evitar a ambiguidade que
/// já causou contato duplicado (número com/sem o 9 virando dois Target
/// diferentes) — ver normalizeBrazilianWaId nos backends.
