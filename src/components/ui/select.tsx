...
/// Fixo em position="popper" + side="bottom" + avoidCollisions={false} pra
/// SEMPRE abrir abaixo do trigger (nunca "virar" pra cima quando falta espaço
/// embaixo) — decisão consciente de UX consistente sobre robustez posicional.
